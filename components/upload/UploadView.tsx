...
export function UploadView({ collections }: { collections: CollectionOption[] }) {
  ...
  return (
    <>
      ...
      {tab === 'ia' ? <IaComingSoon /> : <CsvImportTab collections={collections} />}
    </>
  )
}

function IaComingSoon() {
  return (
    <>
      <div
        className="text-center rounded-[18px]"
        style={{ padding: '26px 18px', border: '1.7px dashed var(--border)', background: 'var(--surface)' }}
      >
        <div
      ...
      <div className="flex gap-[9px]">
        <div className="flex-1 text-left rounded-2xl" style={{ padding: 13, background: 'var(--accent-soft)', border: '1.5px solid var(--accent)' }}>
        ...
        <div className="flex-1 text-left rounded-2xl" style={{ padding: 13, background: 'var(--surface)', border: '1.5px solid var(--border)' }}>
      ...
      <button
        ...
        style={{ marginTop: 24, padding: 15, color: 'var(--on-accent)', background: 'var(--accent)', opacity: 0.6, cursor: 'not-allowed' }}
      >
